...
sub.innerHTML="";
if(cat==="vestuario"){
sub.innerHTML+="<option value='camisa'>Camisas</option><option value='bone'>Bonés</option><option value='shorts'>Shorts</option>";
}
if(cat==="cerveja"){
sub.innerHTML+="<option value='cerveja'>Cerveja</option>";
}
if(cat==="acessorios"){
sub.innerHTML+="<option value='patch'>Patch</option><option value='bottons'>Bottons</option><option value='cafe'>Café</option>";
}}
...
if(!nome||!categoria||!sub||!preco||!imgFile){alert("Preencha todos os campos!");return;}
